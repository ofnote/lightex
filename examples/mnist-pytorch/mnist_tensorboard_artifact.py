...
# and https://github.com/mlflow/mlflow/tree/master/examples/pytorch
...
print ('args enable cuda', type(args.enable_cuda), args.enable_cuda)

enable_cuda_flag = True if args.enable_cuda == 'True' else False

args.cuda = enable_cuda_flag and torch.cuda.is_available()

print (f'torch cuda {torch.cuda.is_available()}, args.cuda = {args.cuda}')
